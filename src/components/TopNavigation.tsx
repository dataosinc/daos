...
import { Save, FileText, Bot, Store, BookOpen, TrendingUp, HelpCircle, Search, Command } from 'lucide-react';
...
export default function TopNavigation({ currentView, onViewChange, onToggleAgentDrawer }: TopNavigationProps) {
